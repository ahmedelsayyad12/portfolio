...
const WORDS = ["frontend diploma at Route Academy", "graduate from MU"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "Next.js"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ahmedelsayyad12" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ahmed-elsyaad-b959a42a5/" },
  { icon: Instagram, link: "https://www.instagram.com/elsyaad3/" }
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden py-12" id="Home">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Frontend Developer | React Specialist | Bridging Engineering Precision with Web Development
                </p>
